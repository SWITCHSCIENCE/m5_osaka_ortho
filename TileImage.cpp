...
main()
{
    ImageSource imgsrc(8, 15, 256, 24800, 21000, "/output/osaka_ortho_files", "jpg");
    char str[256];

    int c, r;
    imgsrc.getTileAtPoint(15, 255, 255, &c, &r);
    imgsrc.getImageUrl(str, sizeof(str), 15, c, r);
    printf("%s\n", str);
    imgsrc.getTileAtPoint(15, 255, 256, &c, &r);
    imgsrc.getImageUrl(str, sizeof(str), 15, c, r);
    printf("%s\n", str);
    imgsrc.getTileAtPoint(15, 256, 255, &c, &r);
    imgsrc.getImageUrl(str, sizeof(str), 15, c, r);
    printf("%s\n", str);
    imgsrc.getTileAtPoint(15, 256, 256, &c, &r);
    imgsrc.getImageUrl(str, sizeof(str), 15, c, r);
    printf("%s\n", str);
    imgsrc.getTileAtPoint(15, 24800 - 1, 21000 - 1, &c, &r);
    imgsrc.getImageUrl(str, sizeof(str), 15, c, r);
    printf("%s\n", str);
    ...
    ret = imgsrc.computeTiledRects(8, {-69, -29, 320, 240}, points, rects, 9);
    imgsrc.printTiledRects(points, rects, ret);

    ret = imgsrc.computeTiledRects(15, {0, 15, 320, 240}, points, rects, 9);
    imgsrc.printTiledRects(points, rects, ret);

    ret = imgsrc.computeTiledRects(15, {-15, 0, 320, 240}, points, rects, 9);
    imgsrc.printTiledRects(points, rects, ret);

    ret = imgsrc.computeTiledRects(15, {0, -15, 320, 240}, points, rects, 9);
    imgsrc.printTiledRects(points, rects, ret);

    ret = imgsrc.computeTiledRects(15, {250, 250, 300, 300}, points, rects, 9);
    imgsrc.printTiledRects(points, rects, ret);

    imgsrc.getTileAtPoint(15, -1, -257, &c, &r);
    printf("%d %d\n", c, r);
}
